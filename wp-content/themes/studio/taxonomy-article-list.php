        ...
        <section class="blogs" id="blog-detail">
            <div class="blogs-wrapper">
                <div class="blogs-photo">
                    ...
                    <?php
                        global $nggdb;
                        $gallery_id = getNextGalleryRubriq($cat_id, 'main_slider_blog_rubric_page');
                    ...
                    ?>
                        <div class="item-slider" style="background-image: url('<?php echo nextgen_esc_url($image->imageURL); ?>');"> </div> 
                    <?php
                        }
                    ?>
                    </div>
                    ...
                    ?>
                    <img src="<?php echo $image_url[0] ? $image_url[0] : '/wp-content/themes/studio/images/creativeBg.jpg'; ?>" alt="">
                    <?php } ?>
                    ...
                    <div class="container">
                        <div class="container-small clearfix">
                            ...
                            <div class="blogs-title wowd fadeIn">
                                <?php echo get_term_meta($cat_id, 'main_text_block_b_blog_rubric_page', true); ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="blogs-lists">
                    <div class="container">
                        <h2 class="wow fadeInUpSmall" data-wow-delay="0.1s"><?php echo get_term_meta($cat_id, 'main_text_block_c_blog_rubric_page', true); ?></h2>
                        <div class="clearfix"></div>
                        
                        <?php foreach($action_list as $action){ ?>
                            <?php
                            $image_url = wp_get_attachment_image_src( get_post_thumbnail_id($action->ID), 'full');
                            $subtitle = wp_trim_words( get_post_meta( $action->ID, 'subtitle_details_block_a_blog_post_page', $single = true ), 15, '...' );
                        ...
                        <div class="blogs-blog">
                            <div class="tdblg-l1">
                                ...
                                <div class="blogs-blog-left">
                                    <div class="bl-full wow fadeInUpSmall blogImgBg" data-wow-delay="0.3s" style="background-image: url('<?php echo $image_url[0]; ?>')"></div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                        </div>
